	...
	<!-- Fixed navbar -->
	 ...
	 <div class="container-fluid" id="below-nav">
						...
						<div class="row-fluid">
							<div class="span12" id="introductions">
								<p id="zh_introduction">
									<label class="label label-info"><i class="glyphicon glyphicon-user"></i>&nbsp;徐家喜</label>
									<!-- 男，1976-，于xxxx年就读于xxxx大学，xxxx年获得高级工程师职称，xxxx年xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->
								</p>
								<p id="en_introduction">
									<label class="label label-info"><i class="glyphicon glyphicon-user"></i>&nbsp;Royxu</label>&nbsp;&nbsp; 
		...
		<div class="row-fluid" id="homework">
			<div class="span12">
				<div class="jumbotron1">
					<h3 class="title-responsive"><i class="glyphicon glyphicon-edit"></i>&nbsp;学生作业</h3>
					...
					<div class="container-fluid">
						<div class="row-fluid">
							<div class="span12" style="text-align:center;">
								<address> 
									<strong id="person_name">徐家喜(Royxu)</strong><br /> 
...
<!-- 模块增删改查主要js -->
<script type="text/javascript" src="${pageContext.request.contextPath}/bjsp/index/index.js"></script>
</body>
</html>